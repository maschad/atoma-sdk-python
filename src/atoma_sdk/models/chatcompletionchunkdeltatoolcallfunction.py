...
class ChatCompletionChunkDeltaToolCallFunctionTypedDict(TypedDict):
    r"""Represents the chat completion chunk delta tool call function.
    ...
    r"""The arguments of the tool call function."""
    name: NotRequired[Nullable[str]]
    r"""The name of the tool call function."""
...
class ChatCompletionChunkDeltaToolCallFunction(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["arguments", "name"]
        nullable_fields = ["arguments", "name"]
        null_default_fields = []
