...
class ConfidentialCompletions(BaseSDK):
    def create(
        self,
        *,
        ciphertext: str,
        ...
        r"""Create confidential completions
        ...
        * Maintains confidentiality throughout the request lifecycle
        ...
        req = self._build_request(
            method="POST",
            path="/v1/confidential/completions",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="confidential_completions_create",
                oauth2_scopes=[],
    ...
    def stream(
        ...
        *,
        ...
        models.ConfidentialCompletionsCreateStreamResponseBody
    ]:
        r"""
        :param ciphertext: The encrypted payload that needs to be processed (base64 encoded)
        :param client_dh_public_key: Client's public key for Diffie-Hellman key exchange (base64 encoded)
        ...
        req = self._build_request(
            method="POST",
            path="/v1/confidential/completions#stream",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                base_url=base_url or "",
                operation_id="confidential_completions_create_stream",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "text/event-stream"):
            return eventstreaming.EventStream(
                ...
                lambda raw: utils.unmarshal_json(
                    raw, models.ConfidentialCompletionsCreateStreamResponseBody
                ),
            )
        if utils.match_response(http_res, ["400", "401", "4XX"], "*"):
            http_res_text = utils.stream_to_text(http_res)
